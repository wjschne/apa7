...
This gets us closer to APA style, but not quite all the way there. Notice that the output is all text. In a few places, it takes us a few steps backwards. The `format` function for this output has a number of options that can get us closer to APA style, but not quite all the way there.
