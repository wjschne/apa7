...
```{r}
#| label: tbl-fabiano
#| tbl-cap:  Pooled Imputation Model Results for Rule Violations Outcome
#| width: 9
#| column: "page-right"
cf <- column_formats()
...
tibble::tribble(
  ...
  apa_flextable(font_size = 10, line_spacing = 1.2, column_formats = cf) |>
...
## Recreating Table from @segalRandomizedControlledTrial2025

```{r}
#| label: tbl-segal
#| tbl-cap: "Sample Characteristics (Counts[%] for Categorical and Mean [StandardDeviations] for Continuous Variables)"
#| width: 9
#| column: "page-right"
d <- tibble(
  Variable = c(
