# Contributing to apa7

This outlines how to propose a change to apa7. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("wjschne/apa7", fork = TRUE)`.
...
Please note that the apa7 project is released with a [Contributor Code
of Conduct](https://wjschne.github.io/apa7/CODE_OF_CONDUCT.md). By
