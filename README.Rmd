...
```{r showcor, message = FALSE, warning = FALSE, fig.alt="A correlation matrix in APA style."}
library(apa7)
# Correlation matrix 
...
```{r showlm, message = FALSE, warning = FALSE, fig.alt="A regression table in APA style."}
...
```{r showcontingence, message = FALSE, warning = FALSE, fig.alt="A contigency table with a chi-square test of independence e in APA style."}
